...
//五一保存用户已领取记录
exports.setTheMayDayUserReceiveRecord = function (accountId,cb) {
    var key = "the_may_day_already_recevied_";
    redisCli.hset(key, accountId, '1', function (err, res) {
        redisCli.pexpire(key, 30 * 24 * 60 * 60 * 1000);
    });
}
//五一获取用户领取记录
exports.getTheMayDayUserReceiveRecord = function (accountId,call) {
    var key = "the_may_day_already_recevied_";
    redisCli.hget(key, accountId, function (err, body) {
        call(body);
    });
