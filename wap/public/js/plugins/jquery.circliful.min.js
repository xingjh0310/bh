            ...
            if($(this).data('text') != undefined) {
                ...
                if($(this).data('type') != undefined) {
                    ...
                    if(type == 'half') {
                        ...
                        $(this).find('.circle-text-half').css({'line-height': (dimension / 1.45) + 'px' });
                    } else {
                        $(this).append('<span class="circle-text">' + icon + text + '</span>');
                        $(this).find('.circle-text').css({'line-height': dimension + 'px' });
                    }
                } else {
                    $(this).append('<span class="circle-text">' + icon + text + '</span>');
                    $(this).find('.circle-text').css({'line-height': dimension + 'px' });
            ...
            if($(this).data('info') != undefined) {
                ...
                if($(this).data('type') != undefined) {
                    ...
                    if(type == 'half') {
                        ...
                        $(this).find('.circle-info-half').css({'line-height': (dimension * 0.7) + 'px', });
                    } else {
                        $(this).append('<span class="circle-info">' + info + '</span>');
                        $(this).find('.circle-info').css({'line-height': (dimension * 0.7) + 'px', });
                    }
                } else {
                    $(this).append('<span class="circle-info">' + info + '</span>');
                    $(this).find('.circle-info').css({'line-height': (dimension * 0.7) + 'px', });
