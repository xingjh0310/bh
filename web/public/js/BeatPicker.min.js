...
BeatPicker.prototype = {
    dateInputNode: null,
    pickerNode: null,
    daysSimple: "日 一 二 三 四 五 六".split(" "),
    daysFull: [],
    monthsSimple: "一月 二月 三月 四月 五月 六月 七月 八月 九月 十月 十一月 十二月".split(" "),
    monthsFull: "1月 2月 3月 4月 5月 6月 7月 8月 9月 10月 11月 12月".split(" "),
    startDate: new Date,
    currentDate: new Date,
    dateFormat: {separator: "-", format: ["YYYY", "MM", "DD"]},
    modules: {header: !0, footer: !0, daysOfTheWeek: !0, navBar: !0, today: !0, gotoDate: !0, icon: !0, clear: !0},
    selectionRule: {
        single: !0,
        range: !1, rangeDisableSelect: !1
    },
    className: {
    ...
    view: {
        ...
        hideOn: "click",
        isInputIsReadonly: !0,
        iconImage: "/img/rl.png"
    },
    labels: {today: "Today", gotoDateInput: "YYYY/MM/DD", gotoDateButton: "GO", clearButton: "Clear"},
    events: {select: "select", change: "change", show: "show", hide: "hide", clear: "clear"},
    disablingRules: [],
    a: null,
    b: null,
    c: [],
    ...
    v: !0,
    w: [],
    x: {days: "days", months: "months", years: "years"},
    y: {briefDate: "BRIEFDATE", yearName: "YEARNAME", yearsRange: "YEARSRANGE"},
    z: {"<": "<", ">": ">", "*": "*"},
    aa: {},
    constructor: function () {
        !window.beatPickerList &&
        (window.beatPickerList = []);
    ...
    ac: function () {
        this.dateInputNode.after(this.a = this.bw("div", {"class": this.bx(this.className.inputParent, this.className._inner.inputContainer)}));
    ...
    ad: function () {
        return this.bw("div", {"class": this.bx(this.className.beatPicker, this.className._inner.beatPicker)},
            this.view.alwaysVisible ? this.a : $("body"))
    },
    ae: function () {
        var a = this, b = this.bw("button", {
        ...
        b.on("click", function () {
            if (a.m || a.n || a.q) {
                ...
                }) : a.selectionRule.single && $.extend(b, {date: a.m, string: a.bf(a.m)});
    ...
    ag: function (a) {
        var b = this;
        a = this.bw("div", {"class": this.bx(this.className.headerNavBarParent, this.className._inner.headerNavBar)}, a, "", !0);
        this.bw("a", {"class": this.bx(this.className.headerNavBarButton, this.className._inner.headerNavBarBtn, this.className._inner.headerNavBarBtnNext, this.className._inner.defaultButton)}, a, ">").on("click", function () {
            b.cb(!1)
        });
        var c = this._currentIndicator = this.bw("a", {"class": this.bx(this.className.headerNavBarButton, this.className._inner.headerNavBarBtn, this.className._inner.headerNavBarBtnMonthIndicator, this.className._inner.defaultButton)}, a).on("click", function () {
            b.cf(!0)
        });
        this.av(c, this.y.briefDate);
        this.bw("a", {"class": this.bx(this.className.headerNavBarButton, this.className._inner.headerNavBarBtn, this.className._inner.headerNavBarBtnPrev, this.className._inner.defaultButton)}, a, "<").on("click", function (a) {
            b.cb(!0)
        })
    },
    ah: function () {
        var a = this.bw("div", {"class": this.className.header});
        this.modules.daysOfTheWeek && a.append(this.ai(this.daysSimple));
        return a
    },
    ai: function (a) {
        if (a instanceof Array) {
            var b = this._weekDayParent = this.bw("ul", {"class": this.className.weekDaysAliasCellParent + " " + this.className._inner.cellParent});
            this.forEach(a, function (a, d) {
                this.bw("li", {"class": this.className.weekDaysAliasCell + " " + this.className._inner.cell}, b, d)
            }, this);
            return b
        }
    },
    aj: function () {
        return this._footerNode = this.bw("div", {
            "class": this.bx(this.className.footer,
                this.className._inner.footer)
        })
    },
    ak: function (a) {
        var b = this;
        this.bw("a", {"class": this.bx(this.className.todayButton, this.className._inner.todayButton, this.className._inner.defaultButton)}, a, this.labels.today).on("click", function (a) {
    ...
    al: function (a) {
        var b = this;
        a = this.bw("div", {"class": this.bx(this.className.gotoDateParent, this.className._inner.gotoDateContainer)}, a);
        var c = this.bw("input", {
            type: "text", "class": this.bx(this.className.gotoDateInput, this.className._inner.gotoDateInput),
    ...
    am: function () {
        var a = this;
        this.cq(this.events.change, {date: this.currentDate, timeStamp: (new Date).getTime()});
        if (!this._daysBody)var b = this._daysBody = this.bw("div", {"class": this.className.days});
        this._daysCellParent &&
        this._daysCellParent.empty();
        this.c.length = this.d.length = this.e.length = 0;
        if (!this._daysCellParent)var c = this._daysCellParent = this.bw("ul", {"class": this.className.daysCellParent + " " + this.className._inner.cellParent}, this._daysBody);
        if (this.view.display === this.x.days) {
            this._weekDayParent && this._weekDayParent.show();
            this._daysBody.find(c).empty();
            for (c = 0; 42 > c; c++) {
                var d = this.bw("li", {"class": this.className.daysCell + " " + this.className._inner.cell}, this._daysCellParent);
                this.c.push(d);
                var e = this.bb(c,
                    d);
        ...
        } else this.view.display === this.x.months ? (this.an(), this.av(this._currentIndicator, this.y.yearName)) : this.view.display === this.x.years && (this.av(this._currentIndicator, this.y.yearsRange),
            this.ao());
        return b
    },
    an: function () {
        ...
        for (var b = 0; 11 >= b; b++) {
            var c = this.bw("li", {"class": this.bx(this.className.monthsCell, this.className._inner.cell, this.className._inner.cellM)}, this._daysCellParent, this.monthsSimple[b]).on("click", function () {
    ...
    ao: function () {
        var a = this;
        this._weekDayParent && this._weekDayParent.hide();
        for (var b = this.ce(this.currentDate.getFullYear()),
                 c = 0; 11 >= c; c++) {
            var d = this.bw("li", {"class": this.bx(this.className.yearsCell, this.className._inner.cell, this.className._inner.cellY)}, this._daysCellParent, b[c]).on("click", function () {
    ...
    aq: function () {
        var a = this.ce(this.currentDate.getFullYear()), b;
        for (b in this.e)this.e[b].data("date", this.cc(a[b], !1)), this.e[b].text("").text(a[b])
    },
    ar: function () {
        var a = this;
    ...
    as: function (a, b) {
        var c = this.at(a, b);
        this.k.css({left: c.x, top: c.y})
    },
    at: function (a, b) {
        var c = this.by(a), d = b && b.x || this.view.position[0], e = b && b.y || this.view.position[1], f = this, g = {
            rightTop: function () {
                d = this._rightCommon();
                ...
                var a;
                +(this._topCommon() + f.k.outerHeight() - $(window).scrollTop()) > $(window).height() ? (a = $(window).height() + $(window).scrollTop() - f.k.outerHeight(), $(window).height() <
                f.k.outerHeight() && (a = $(window).scrollTop())) : a = this._topCommon();
                return Math.floor(a)
        ...
        if (isNaN(d) && isNaN(e)) {
            var h = d, k = e.substr(0, 1).toUpperCase() + this.view.position[1].substr(1), h = "*" === d && "*" === e ? "**" : "*" == e ? h : h + k;
            "**" === h && this.view.alwaysVisible && (h = "bottomLeft");
            h in g && g[h]()
        } else isNaN(d) ||
        isNaN(e) || g.customAdjustment();
        return {y: e, x: d}
    },
    au: function (a) {
        a = $(a.currentTarget || a.originalEvent.currentTarget);
        var b = a.data("date"), c = this.bf(b), d = {};
        ...
        }, this.t ? (this.p && this.cl(this.p), this.p = a, this.n = this.o = b, $.extend(d, {fromDate: this.n}), this.cq(this.events.select, d), this.dateInputNode.val(c), this.show({currentTarget: this.b[0]})) : this.u && (this.s && this.cl(this.s), this.s = a, this.q = this.r = b, $.extend(d, {toDate: this.q}), this.cq(this.events.select, d), this.b.val(c), this.cd() && !this.n && this.show(this.dateInputNode)), this.ck(a), this.n && this.q && this.co(this.n,
            this.q)) : (this.r = this.q ? new Date(this.q.getTime()) : null, this.o = this.n ? new Date(this.n.getTime()) : null))
    },
    av: function (a, b) {
        if (a)if (b === this.y.briefDate)(a || this._currentIndicator).text(this.currentDate.getFullYear() + "年" + this.monthsFull[this.currentDate.getMonth()]); else if (b === this.y.yearName)(a || this._currentIndicator).text(this.currentDate.getFullYear()); else if (b === this.y.yearsRange) {
    ...
    aw: function (a,
        ...
        var d = {
            ...
            MM: "Month",
            DD: "Date"
        }, e = this.currentDate["get" + d[b]](), f = new Date(this.currentDate.getTime());
    ...
    ay: function (a) {
        ...
        if (this.view.display === this.x.days) {
            ...
            for (var b in this.c)a = this.bb(+b, this.c[b]), this.c[b].data("click-behaviour", a.isNextMonth), $(this.c[b]).text("").text(a.day), this.selectionRule.single && this.ba(this.c[b].data("date"), this.c[b]);
            this.selectionRule.range && this.co(this.n, this.q);
            this.az(new Date);
            this.av(this._currentIndicator, this.y.briefDate)
        } else this.view.display === this.x.months ?
            (this.ap(), this.av(this._currentIndicator, this.y.yearName)) : this.view.display === this.x.years && (this.aq(), this.av(this._currentIndicator, this.y.yearsRange))
    },
    az: function (a) {
    ...
    bb: function (a, b) {
        ...
        e.firstDay && (d = a + 1 - (e.firstDay + d.nowMonthDays), c.setMonth(c.getMonth() + 1), c.setDate(d), b.addClass(this.className._inner.notNotable), f = !0, a = d);
        b.data("date", c);
        this.bq(c, b);
        return {day: a, isNextMonth: f}
    },
    bc: function (a) {
        var b = new Date(a.getTime());
        b.setDate(1);
        return {firstDay: b.getDay(), date: a.getDate(), day: a.getDay(), month: a.getMonth(), year: a.getFullYear()}
    },
    bd: function (a) {
        var b = a.getMonth();
        a = a.getFullYear();
        return {
            ...
            nextMonthDays: this.be(11 <
            b + 1 ? 1 : b, 11 < b + 1 ? a + 1 : a)
        }
    },
    be: function (a, b) {
    ...
    bf: function (a) {
        ...
        a = a.getFullYear();
        var d = "NM" == this.dateFormat.format[0] || "NM" == this.dateFormat.format[1] || "NM" == this.dateFormat.format[2], e = {
            DD: 10 <= +b || d ? +b : "0" + b,
            MM: 10 <= c ? c : "0" + c,
            YYYY: a,
            YY: String(a).substr(2),
            NM: this.monthsFull[+c - 1]
        }, f = this.dateFormat.separator, g = "";
    ...
    bj: function (a, b, c) {
        if (a = this.bl(a,
                b))this.bi(c), this.w.unshift(a), c ? (0 === this._lastIndexOfToDate && (this._lastIndexOfToDate = 1), this._lastIndexOfFromDate = 0) : (0 === this._lastIndexOfFromDate && (this._lastIndexOfFromDate = 1), this._lastIndexOfToDate = 0)
    },
    bk: function () {
        for (var a in this.disablingRules) {
            var b = this.disablingRules[a], c = b.from, d = b.to;
    ...
    bl: function (a, b) {
        var c = !isNaN(Date.parse(a)) ||
            a instanceof Date, d = !isNaN(Date.parse(b)) || b instanceof Date;
        this.cs(a);
        this.cs(b);
        this.ct(a);
        this.ct(b);
        var e = {fromDate: null, toDate: null, fromMonth: null, toMonth: null, fromYear: null, toYear: null};
    ...
    bo: function (a, b) {
        var c = this, d = {
            ">": this.bs, "<": this.bt, "*": function (d, e) {
                if (c.bs(a, b, !0) || "*" === b.fromYear)return "*" === e.toYear ? "*" === e.toMonth ? "*" === e.toDate ? !0 : d.date == e.toDate : "*" === e.toDate ? d.month == e.toMonth : d.month == e.toMonth && d.date == e.toDate : "*" === e.toMonth ? "*" === e.toDate ? d.year == e.toYear : d.year ==
                e.toYear && d.date == e.toDate : "*" === e.toDate ? d.year == e.toYear && d.month == e.toMonth : d.year == e.toYear && d.month == e.toMonth && d.date == e.toDate
            }
        }, e;
        for (e in b) {
    ...
    bt: function (a, b, c) {
        c = c ? "from" : "to";
        return a.year < b[c + "Year"] || a.year == b[c + "Year"] && a.month < b[c + "Month"] ? !0 : a.date <= b[c + "Date"] && b[c + "Year"] == a.year &&
        b[c + "Month"] == a.month
    },
    bu: function (a, b, c) {
        c = c ? "from" : "to";
    ...
    by: function (a) {
        var b = $(window).outerHeight(), c = $(window).outerWidth(), d = $(a)[this.view.alwaysVisible ? "position" : "offset"]().top, e = $(a)[this.view.alwaysVisible ? "position" : "offset"]().left, f = $(a).outerHeight();
        a = $(a).outerWidth();
        return {height: f, width: a, x: e, y: d, winHeight: b, winWidth: c}
    },
    bz: function () {
        var a = this;
    ...
    ca: function (a) {
        this.u = !1;
        this.t = !0;
        a && a.currentTarget === this.b[0] ? (this.u = !0, this.t = !1, this.bi(!1), this.n &&
        this.bj(this.n, "<", !0)) : (delete this.w[this._lastIndexOfFromDate], this.q && this.bj(this.q, ">", !1));
        this.bh();
    ...
    cc: function (a, b) {
        var c = new Date;
        c.setMonth(b);
        b ? (c.setFullYear(this.currentDate.getFullYear()), c.setMonth(a)) :
            (c.setFullYear(a), c.setMonth(1));
        c.setDate(1);
        return c
    },
    cd: function () {
    ...
    cf: function (a, b) {
        var c = this, d = {
            1: function () {
                ...
                c.av(c._currentIndicator,
                    c.y.yearsRange);
                c.view.display = c.x.years
            }
        }, e = {days: 1, months: 2, years: 3, yearsRange: 4};
        if (d = a ? d[e[this.view.display] + 1] : d[e[this.view.display] - 1])this.currentDate = b ? new Date(b.getTime()) : this.currentDate, d(), this.am()
    },
    cg: function (a) {
        if (a.val()) {
            a = a.val().split("/");
            var b = new Date;
            1 === a.length ? (this.view.display = this.x.years, b.setFullYear(a[0])) : 2 === a.length ? (this.view.display = this.x.months, b.setFullYear(a[0]), b.setMonth(a[1])) : 3 === a.length && (this.view.display = this.x.days, b.setFullYear(a[0]), b.setMonth(a[1]),
                b.setDate(a[2]));
    ...
    ci: function (a, b) {
        for (var c = [], d = a; d <= b;)c.push(new Date(d)), d = this.cj(d, 1);
        return c
    },
    cj: function (a, b) {
    ...
    co: function (a, b) {
        ...
        for (var d in this.c) {
            var e = $(this.c[d]), f = e.data("date");
            this.cl(e);
            a && b ? (e.removeClass(this.className.betweenRange + " " + this.className._inner.betweenDateNode), f = this.bc(f), this.bu(f, c, !0) || this.bu(f, c, !1) ? this.ck(e) : this.bs(f, c, !0) && this.bt(f, c, !1) && e.addClass(this.className.betweenRange +
                " " + this.className._inner.betweenDateNode)) : a ? this.ch(this.n, f) && this.ck(e) : b && this.ch(this.q, f) && this.ck(e)
        }
    },
    cp: function () {
    ...
    on: function (a, b, c) {
        a && "string" === typeof a &&
        b && (!this.aa[a] && (this.aa[a] = []), this.aa[a].push({func: b, scope: c ? c : this.k}))
    },
    show: function (a) {
        this.k.css("display", "");
        this.v = !1;
    ...
    reset: function () {
        this.selectionRule.range ? ((this.p || this.s) && this.cl(this[this.p ? "p" : "s"].add(this.s)),
            this.bi("BOTH"), delete this.w[this._lastIndexOfFromDate], delete this.w[this._lastIndexOfToDate], this.q = this.s = this.n = this.p = this._lastIndexOfFromDate = this._lastIndexOfToDate = this.r = this.o = null, this.ay(), this.cp()) : (this.cl(this.l), this.l = this.m = null);
    ...
    selectDate: function (a) {
        if (!isNaN(Date.parse(a)) && (a = this.cr(a) ? a : new Date(Date.parse(a)), this.ax(a, null, !0), this.c && this.c.length))for (var b in this.c)if (this.ch(this.c[b].data("date"),
                a))return this.c[b].click()
    },
...
_interpretDisableRules = function (a) {
    ...
    if (!b)return {};
    a = [];
    var b = b.replace(/\s+/g, ""), b = b.split("}"), b = b.filter(function (a) {
        return "" !== a
    }), c;
    for (c in b) {
        var d = b[c] += "}";
    ...
    return {disablingRules: a}
};
_interpretPosition = function (a) {
    return (a = a.data("beatpicker-position")) ? {view: {position: _parseJsonEngine(a, [])}} : {}
};
_interpretRange = function (a) {
    ...
    var b = a.split(",");
    a = "true" === b[0];
    return {selectionRule: {range: a, rangeDisableSelect: "true" === b[1], single: !a}}
};
_interpretDateFormat = function (a) {
    var b = a.data("beatpicker-format");
    if (!b)return {};
    var b = b.replace(/\s+/g, ""), c = b.indexOf("]");
    a = b.substr(0, c + 1);
    b = b.substr(c + 2, b.length);
    return {dateFormat: $.extend({format: _parseJsonEngine(a, [])}, b ? _parseJsonEngine("{" + b + "}", ["separator"]) : {separator: "-"})}
};
